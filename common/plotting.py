...
class History(object):
    ...
    def add_group(self, group_name, line_names, increasing=True):
        if group_name in self.line_groups:
            self.line_groups[group_name].increasing = increasing
            for line_name in line_names:
                if line_name not in self.line_groups[group_name].lines:
                    self.line_groups[group_name].lines[line_name] = Line()
        else:
