...
none of them is completely broken (to the point where the face is hardly recognizable).
When training a similar model without LIS modules, it will generate fully broken faces.
The modules prevent such gross errors.
