...
First image per group shows the image generated by G when using the original noise vector (input space).
All following images show the image s generated by G when using the noise vectors generated by the first, second or third LIS module.
